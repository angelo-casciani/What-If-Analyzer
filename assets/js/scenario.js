...
function showScenarioComparison() {
    ...
    insertCostComparison(scenario1,scenario2,scenario3);
    insertTimeComparison(scenario1,scenario2,scenario3);
    insertMouldComparison(scenario1,scenario2,scenario3);
